//
//  AlISalesTableViewCell.swift
//  Stokisha
//
//  Created by Ian Omondi on 15/04/2025.
//

import UIKit

class AllSalesTableViewCell: UITableViewCell {
    
    static let reuseIdentifier = "AllSalesTableViewCell"
    ...
    private let initialsLabel: UILabel = {
        ...
        label.backgroundColor = UIColor(red: 0/255, green: 28/255, blue: 45/255, alpha: 1.0) // Dark blue
    ...
    private let quantityLabel: UILabel = {
        ...
        label.textColor = UIColor(red: 0/255, green: 28/255, blue: 45/255, alpha: 1.0) // Dark blue
    ...
    private func setupDarkModeSupport() {
        ...
        productLabel.textColor = UIColor { trait in
    ...
    func configure(with sale: Sale) {
        ...
        quantityLabel.text = "+\(sale.quantitySold)"
        initialsLabel.text = getInitials(from: sale.productName)
        timeLabel.text = formatDate(sale.saleDate)
    }
